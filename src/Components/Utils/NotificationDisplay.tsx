...
import AsyncStorageWrapper from '../AsyncStorage/AsyncStorageValue';
...
class NotificationService {
  ...
  static async getFcmToken(): Promise<string | null> {
    try {
      let fcmToken: string | null = await AsyncStorageWrapper.getItem('FCM_TOKEN');
  ...
  static async updateFcmToken(dispatch:any) {
    try {
      ...
      if (newFcmToken) {
        await AsyncStorageWrapper.setItem('FCM_TOKEN', newFcmToken);
  ...
  static handleTokenRefresh(dispatch:any) {
    ...
    return onTokenRefresh(messaging, async newToken => {
      ...
      await AsyncStorageWrapper.setItem('FCM_TOKEN', newToken);
